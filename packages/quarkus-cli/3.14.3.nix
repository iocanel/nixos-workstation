...
# Usage:
# - Using the CLI:
#   nix-shell -p 'with import <nixpkgs> {}; callPackage /etc/nixos/packages/quarkus-cli/3.14.3.nix {}'
...
#   pkgs.mkShell {
#     buildInputs = [
#       (pkgs.callPackage /etc/nixos/packages/quarkus-cli/3.14.3.nix {})
#     ];
#   
#     shellHook = ''
#       echo "Quarkus CLI 3.14.3 is available in this shell."
#     '';
#   }
...
# Use nix-prefetch-url to test the download and get the hash
  src = fetchurl {
    ...
    sha256 = "1a7l3ll8s4bi2zwjs6swlq5ca517i5xgdz4p9y8h6fl5x82665ds";
  };
